  ...
  const toggleTag = (tag) => {
    if (tags.includes(tag)) {
      ...
      if (tag === "posée par un proche") {
        ...
        getMemories_Question(subject_active, setQuestion, setAnswers, setOwner, index, tags, true);
      }
    }
  };
  ...
  useFocusEffect(
    React.useCallback(() => {
      ...
      if (session && subject_active != null) {
        ...
        getMemories_Question(subject_active, setQuestion, setAnswers, setOwner, index, tags,personal);
